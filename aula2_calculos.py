...
# / Divisão           Serve para dividir valores
...
resultado = numero_1 - numero_2
print("A subtração do numero 1 com o numero 2 é:",resultado)
...
reultado = numero_1 % numero_2
print("O resto de divisão do numero 1 com o numero 2 é:",resultado)